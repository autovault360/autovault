...
import CpaProfitVehiclesReportChartsRow from "@/components/cpa/profit-vehicles-report/cpa-profit-vehicles-report-charts-row";
import CpaProfitVehiclesReportKpiStrip from "@/components/cpa/profit-vehicles-report/cpa-profit-vehicles-report-kpi-strip";
import CpaProfitVehiclesReportSkeleton from "@/components/cpa/profit-vehicles-report/cpa-profit-vehicles-report-skeleton";
import CpaProfitVehiclesReportTableSection from "@/components/cpa/profit-vehicles-report/cpa-profit-vehicles-report-table-section";
import type { CpaProfitVehiclesReportData } from "@/lib/cpa/profit-vehicles-report/types";

export default function ProfitVehiclesReportPage({
  data,
}: {
  data: CpaProfitVehiclesReportData | null;
}) {
