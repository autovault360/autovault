  ...
  return (
    ...
    >
      <ModalHeader
        ...
        title={`Edit ${vehicle.displayTitle}`}
        subtitle="Update vehicle details below."
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input theme="dark" value={field.value ?? ""} onChange={field.onChange} placeholder="Trim" />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input theme="dark" type="number" value={field.value ?? ""} onChange={(e) => field.onChange(Number(e.target.value) || 0)} placeholder="0" />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                          ...
                          <SelectContent theme="dark">
                            {INTERIOR_COLORS.map((c) => (
                              <SelectItem key={c.value} value={c.value} theme="dark">
                                <span className="flex items-center gap-2">
                                  {c.swatch && (
                                    <span className="h-3.5 w-3.5 shrink-0 rounded-full border border-slate-500" style={{ backgroundColor: c.swatch }} />
                                  )}
                                  {c.label}
                                </span>
                              </SelectItem>
                  ...
                  <FormField
                    ...
                    render={({ field, fieldState }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input theme="dark" value={field.value} onChange={field.onChange} placeholder="STK-001" aria-invalid={!!fieldState.error} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input mode="date" theme="dark" value={field.value ?? ""} onChange={(e) => field.onChange(e.target.value)} />
                        </FormControl>
                      </FormItem>
                    )}
                  />
            ...
            <div className="md:w-1/2">
              <FormSection title="Pricing & Cost" theme="dark">
                <FormGrid cols={3}>
                  ...
                  <FormField control={form.control} name="marketValue" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input mode="currency" theme="dark" value={field.value} onValueChange={field.onChange} />
                      </FormControl>
                    </FormItem>
                  )} />
                </FormGrid>
                <FormGrid cols={3}>
                  ...
                  <FormField control={form.control} name="reconditioningCost" render={({ field }) => (
                    <FormItem>
                  ...
                  <div>
                    ...
                    <FormControl>
                      <Input mode="currency" theme="dark" value={totalInvested} onValueChange={() => {}} disabled />
                    </FormControl>
                  </div>
                </FormGrid>
              </FormSection>
