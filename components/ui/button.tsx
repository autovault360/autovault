  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-[4px] border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      ...
      size: {
        ...
        sm:
          "h-7 gap-1 rounded-[4px] px-2.5 text-[11.5px] has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3.5",
        lg:
          "h-9 gap-1.5 px-3 text-[11.5px] has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2",
        icon:
          "size-8",
        "icon-xs":
...
const darkVariantClass: Record<string, string> = {
  ...
  secondary:
    "bg-slate-700 text-slate-200 hover:bg-slate-600 aria-expanded:bg-slate-600 aria-expanded:text-slate-200",
  ghost:
    "text-slate-300 hover:bg-slate-800 hover:text-slate-100 aria-expanded:bg-slate-800 aria-expanded:text-slate-100",
  destructive:
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        theme === "dark" && variant && darkVariantClass[variant],
        className,
      )}
      {...props}
    />
