...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      theme={theme}
      className={cn(
        "flex-1 rounded-none border-0 bg-transparent px-0 shadow-none ring-0 focus-visible:border-0 focus-visible:ring-0 disabled:bg-transparent aria-invalid:ring-0 dark:bg-transparent dark:disabled:bg-transparent",
        className,
      )}
      {...props}
    />
