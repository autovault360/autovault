...
async function main() {
  ...
  if (dryRun) {
    console.log("�•‘   �Ÿ”� DRY RUN �€” no changes will be made  �•‘");
  }
  console.log("�•š�•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•��•�");
  console.log("");
  ...
  console.log("Step 1/15: deal_jackets...");
  {
    ...
    if (error) console.error(`  �œ�€” ${error.message}`);
    else console.log(`  �œ“ ${data?.length ?? 0} deleted`);
  }
  ...
  console.log("Step 14/15: files (vehicle/customer/deal/deal_jacket)...");
  {
    ...
    for (const entity of entities) {
      ...
      const { data, error } = await query.select("id");
      if (error) console.error(`  �œ�€” ${entity}: ${error.message}`);
      else console.log(`  �œ“ ${entity}: ${data?.length ?? 0} deleted`);
    }
  }
