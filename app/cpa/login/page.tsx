...
const hero: LoginHeroContent = {
  ...
  description:
    "Dedicated CPA access for financial review, tax reporting, payroll analysis, and compliance management across your dealership group.",
  features: [
    {
      icon: BadgeCheck,
      title: "Secure by Design & Role-Based",
      description:
        "Enterprise-grade security with role-based access ensures only authorized CPAs can view financial data.",
    },
    {
      icon: BarChart3,
      title: "Real-Time Financial Insights",
      description:
        "Track revenue, payroll, sales tax, and profitability with real-time dashboards built for CPAs.",
    },
    {
      icon: PieChart,
      title: "All-in-One Compliance Hub",
      description:
        "Manage sales tax filings, payroll reports, deal jacket audits, and financial exports from a single dashboard.",
    },
  ],
};
  ...
  return (
    <LoginPageShell hero={hero}>
      <LoginFormCard
        ...
        subtitle={
          <>
            Sign in to access your <span className="text-primary font-medium">CPA</span> dashboard.
          </>
        }
      >
        <form className="mt-9 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-2">
            <label htmlFor="cpa-email" className="text-[13px] font-normal text-zinc-400">
              Email Address
            </label>
          ...
          <div className="space-y-2">
            <label htmlFor="cpa-password" className="text-[13px] font-normal text-zinc-400">
              Password
            </label>
            <div className="relative flex items-center">
