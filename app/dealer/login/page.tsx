...
const hero: LoginHeroContent = {
  ...
  description:
    "Dedicated wholesale portal for dealer-to-dealer inventory trading, wholesale pricing, and bulk transactions across your dealership network.",
  features: [
    {
      icon: BadgeCheck,
      title: "Secure & Role-Based",
      description:
        "Enterprise-grade security ensures only authorized wholesale dealers can access inventory and transactions.",
    },
    {
      icon: BarChart3,
      title: "Real-Time Inventory Sharing",
      description:
        "Browse and list wholesale inventory in real-time across your dealer network with instant availability updates.",
    },
    {
      icon: PieChart,
      title: "All-in-One Wholesale Hub",
      description:
        "Manage wholesale listings, track dealer transactions, and view P&L from a single dashboard built for wholesale dealers.",
    },
  ],
};
  ...
  return (
    <LoginPageShell hero={hero}>
      <LoginFormCard
        ...
        subtitle={
          <>
            Sign in to access your <span className="text-primary font-medium">Wholesale</span>{" "}
            dashboard.
          </>
        }
      >
        <form className="mt-9 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-2">
            <label htmlFor="dealer-email" className="text-[13px] font-normal text-zinc-400">
              Email Address
            </label>
          ...
          <div className="space-y-2">
            <label htmlFor="dealer-password" className="text-[13px] font-normal text-zinc-400">
              Password
            </label>
            <div className="relative flex items-center">
