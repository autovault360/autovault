...
import type { MonthStripDay } from "./admin-calendar-utils";
...
export default function AdminCalendarMonthStrip({
  days,
  selectedDay,
  onSelectDay,
}: Props) {
        ...
        {days.map((d) => {
          ...
          return (
            ...
            >
              ...
              {d.eventCount > 0 && (
                <span className="mt-0.5 h-1 w-1 rounded-full bg-blue-400/80" />
              )}
            </button>
          );
        })}
