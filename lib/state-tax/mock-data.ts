...
export const STATE_TAX_MOCK_REPORT: StateTaxReport = {
  ...
  monthlyTaxData: [
    { name: "Jan", tax: 0, vehicles: 0 },
    { name: "Feb", tax: 0, vehicles: 0 },
    { name: "Mar", tax: 0, vehicles: 0 },
    { name: "Apr", tax: 0, vehicles: 0 },
    { name: "May", tax: 12500, vehicles: 4 },
    { name: "Jun", tax: 8400, vehicles: 3 },
    { name: "Jul", tax: 0, vehicles: 0 },
    { name: "Aug", tax: 0, vehicles: 0 },
    { name: "Sep", tax: 0, vehicles: 0 },
    { name: "Oct", tax: 0, vehicles: 0 },
    { name: "Nov", tax: 0, vehicles: 0 },
    { name: "Dec", tax: 0, vehicles: 0 },
  ],
  reminders: [],
  periods: [],
};
